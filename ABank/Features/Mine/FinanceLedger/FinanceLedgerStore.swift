...
final class FinanceLedgerStore {
    ...
    private let defaultsKey = "abank.financeLedger.record"
    ...
    func incomeExpensePageData(month: String = "2026-08", accountId: String? = nil) -> IncomeExpensePageData {
        let record = load()
        var txs = record.transactions.filter { $0.date.hasPrefix(month) }
        if let accountId {
        ...
        let monthNumber = Int(month.split(separator: "-").last ?? "8") ?? 8
        ...
        return IncomeExpensePageData(
            ...
            accountFilter: accountId == nil ? "全部账户" : record.accounts.first(where: { $0.id == accountId })?.cardLabel ?? "全部账户",
            summary: monthlyFlow(for: month),
            dayGroups: dayGroups
        )
    }
    ...
    private static func seedTransactions(accountId: String) -> [LedgerTransaction] {
        [
            LedgerTransaction(id: "tx_001", accountId: accountId, date: "2026-08-01", time: "09:12", title: "ATM取款", direction: .expense, amount: 1934.91, balanceAfter: 0, iconKey: "banknote"),
            LedgerTransaction(id: "tx_002", accountId: accountId, date: "2026-08-02", time: "11:30", title: "转账-收入", direction: .income, amount: 3000, balanceAfter: 0, iconKey: "arrow.down.left"),
            LedgerTransaction(id: "tx_003", accountId: accountId, date: "2026-08-10", time: "09:30", title: "工资", direction: .income, amount: 14_116.04, balanceAfter: 0, iconKey: "yensign.circle"),
            LedgerTransaction(id: "tx_004", accountId: accountId, date: "2026-08-10", time: "14:22", title: "微信支付", direction: .expense, amount: 571, balanceAfter: 0, iconKey: "message"),
            LedgerTransaction(id: "tx_005", accountId: accountId, date: "2026-08-10", time: "16:45", title: "转账-欧梦瑶", direction: .expense, amount: 11_500, balanceAfter: 0, iconKey: "person.crop.circle"),
            LedgerTransaction(id: "tx_006", accountId: accountId, date: "2026-08-11", time: "18:06", title: "财付通", direction: .income, amount: 89, balanceAfter: 0, iconKey: "creditcard"),
            LedgerTransaction(id: "tx_007", accountId: accountId, date: "2026-08-15", time: "19:58", title: "支付宝", direction: .expense, amount: 10, balanceAfter: 0, iconKey: "a.circle"),
            LedgerTransaction(id: "tx_008", accountId: accountId, date: "2026-08-15", time: "20:14", title: "抖音支付(河南...", direction: .expense, amount: 39, balanceAfter: 0, iconKey: "music.note")
        ]
    }
}
